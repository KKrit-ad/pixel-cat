...
- **เสียงเหมียว** — เสียงลูกแมวสังเคราะห์เองด้วยคณิตศาสตร์ (ไม่ได้เอาไฟล์เสียงจากที่ไหนมา) ฝังเป็น WAV base64 ในแอปเลยไม่ต้องพก resource: ทัก/เปิดกล่องพูด = `เหมียว` เต็มเสียง, ถูกลูบ = ครางเบา ๆ, ตะปบโดน = ครืดๆ ดีใจ, ตะปบพลาดหรือร่วงจากที่สูง = เสียงตกใจ, ตอบสำเร็จ = ครืดๆ; ดังเบาไว้ที่ 32% กันเสียงรัวด้วยการเว้นจังหวะ และ **เงียบเองอัตโนมัติ** ระหว่างโหมดโฟกัส ตอนสั่งให้นอน และตอนหลับ ปิดถาวรได้จากเมนู `เสียงเหมียว`
...
| `make-cat-voice.py` | สังเคราะห์เสียงลูกแมวใหม่แล้วฝังลง `Sources/CatVoiceData.swift` |
